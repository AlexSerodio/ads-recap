...
import furb.AndysFirstDictionary;
...
public class AndysFirstDictionaryTest {
	...
	public void test01() {
		fd = new AndysFirstDictionary();
		String[] lines = { "vader", "if", "you", "only", "knew", "the", "power", "of", "the", "dark", "side", "ObiWan",
		...
		String s;
		int i = 0;
		String[] words = { "dark", "father", "happened", "if", "knew", "never", "obiwan", "of", "only", "power", "side",
				"the", "to", "told", "vader", "what", "you", "your" };
		while (iterator.hasNext()) {
			s = iterator.next();
			Assert.assertEquals(words[i].toLowerCase(), s);
			i++;
